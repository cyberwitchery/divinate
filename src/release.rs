...
mod tests {
    ...
    fn malformed_or_ambiguous_origins_are_rejected() {
        for origin in [
            "https://dev.azure.com/example-org/example-project/example-repository",
            "https://dev.azure.com/example-org/example-project/_git/one/extra",
            "git@ssh.dev.azure.com:v3/example-org/example-project",
